	...
	?>
										...
										<tbody>
											...
											<tr valign="top">
												...
												<td class="forminp forminp-textarea">
													...
													<?php
														printf( '<textarea name="pfa_description[%1$s]" id="pfa_description_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $i, ( isset( $pf_filters_advanced['pfa_description'][$i] ) ? $pf_filters_advanced['pfa_description'][$i] : '' ) );
													?>
												</td>
											</tr>
											<tr valign="top">
											...
											<tr valign="top">
												...
												<td class="forminp forminp-select">
													...
													?>
													<span class="description"><?php _e( 'Select style preset to use with the current taxonomy (works only with product attributes).', 'prdctfltr' ); ?> DEPRECATED DO NOT USE! USE PAINT BUCKET TOOL AND SET APPEARANCE TO TEXT!</span>
												</td>
											</tr>
											<tr valign="top">
												<th scope="row" class="titledesc">
										...
										<tbody>
											...
											<tr valign="top">
												...
												<td class="forminp forminp-textarea">
													<p style="margin-top:0;"><?php _e( 'Enter description for the current filter. If entered small text will apprear just bellow the filter title.', 'prdctfltr' ); ?></p>
													<?php
														printf( '<textarea name="pfr_description[%1$s]" id="pfr_description_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $q, ( isset( $pf_filters_range['pfr_description'][$q] ) ? $pf_filters_range['pfr_description'][$q] : '' ) );
													?>
												</td>
											</tr>
											<tr valign="top">
											...
											<tr valign="top">
												...
												<td class="forminp forminp-textarea">
													...
													<?php
														printf( '<textarea name="pfr_custom[%1$s]" id="pfr_custom_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $q, ( isset( $pf_filters_range['pfr_custom'][$q] ) ? $pf_filters_range['pfr_custom'][$q] : '' ) );
													?>
												</td>
											</tr>
										</tbody>
		...
		<?php
			...
			if ( isset( $_GET['section'] ) && $_GET['section'] == 'register' ) {
				...
				$more_overrides_std = ( WC_Prdctfltr::$settings['wc_settings_prdctfltr_custom_tax'] == 'yes' ? array( 'product_cat', 'product_tag', 'characteristics' ) : array( 'product_cat', 'product_tag' ) );
				...
				$settings = array(
					...
					'prdctfltr_default_templates' => array(
						...
						'type' => 'checkbox',
						'desc' => __( 'If you have disabled the Product Filter Override Templates option at the top, then your default WooCommerce or', 'prdctfltr' ) . ' ' . $curr_theme->get( 'Name' ) . ' ' . __( 'filter templates will be shown. If you want do disable these default templates too, check this option. This option can be useful for the widget version of the Product Filter.', 'prdctfltr' ),
					...
					'section_ajax_title' => array(
						...
						'type' => 'title',
						'desc' => __( 'AJAX Shop/Product Archives Settings - Setup this section to use AJAX on Shop and Product Archive pages.', 'prdctfltr' )
					),
					...
					'prdctfltr_product_animation' => array(
						'name' => __( 'NU-LL-24.N-E-T-Select Product Loading Animation', 'prdctfltr' ),
						'type' => 'select',
			...
			<?php
				...
				$settings = array(
					...
					'section_char_filter_title' => array(
						...
						'type'     => 'title',
						'desc'     => __( 'N.U-LL-24.N-E-T-Setup filter. Check following link for more information.', 'prdctfltr' ) . ' <a href="http://mihajlovicnenad.com/product-filter/documentation-and-full-guide-video/">' . __( 'Documentation & Knowledge Base', 'prdctfltr' ) . '</a><span class="wcpfs_char"></span>'
					),
					...
					foreach ( $attribute_taxonomies as $tax) {
						...
						$settings = $settings + array(
							...
							'prdctfltr_pa_' . $tax->attribute_name => array(
								'name' => __( 'Appearance', 'prdctfltr' ) . ' DEPRECATED DO NOT USE! USE PAINT BUCKET TOOL AND SET APPEARANCE TO TEXT!',
								'type' => 'select',
				...
				<?php
					...
					$curr_overrides = WC_Prdctfltr::$settings['wc_settings_prdctfltr_more_overrides'];
				...
				<tbody>
					...
					<tr valign="top">
						...
						<td class="forminp forminp-textarea">
							<p style="margin-top:0;"><?php _e( 'Enter description for the current filter. If entered small text will apprear just bellow the filter title.', 'prdctfltr' ); ?></p>
							<?php
								printf( '<textarea name="pfa_description[%1$s]" id="pfa_description_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $pf_id, ( isset( $_POST['pfa_description'] ) ? $_POST['pfa_description'] : '' ) );
							?>
						</td>
					</tr>
					<tr valign="top">
				...
				<tbody>
					...
					<tr valign="top">
						...
						<td class="forminp forminp-textarea">
							<p style="margin-top:0;"><?php _e( 'Enter description for the current filter. If entered small text will apprear just bellow the filter title.', 'prdctfltr' ); ?></p>
							<?php
								printf( '<textarea name="pfr_description[%1$s]" id="pfr_description_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $pf_id, ( isset( $_POST['pfr_description'] ) ? $_POST['pfr_description'] : '' ) );
							?>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<td class="forminp forminp-textarea">
							<p style="margin-top:0;"><?php _e( 'Enter custom settings for the range filter. Visit this page for more information ', 'prdctfltr' ); ?> <a href="http://ionden.com/a/plugins/ion.rangeSlider/demo.html" target="_blank">http://ionden.com/a/plugins/ion.rangeSlider/demo.html</a></p>
							<?php
								printf( '<textarea name="pfr_custom[%1$s]" id="pfr_custom_%1$s" type="text" style="max-width:600px;margin-top:12px;min-height:90px;">%2$s</textarea>', $pf_id, ( isset( $_POST['pfr_custom'] ) ? $_POST['pfr_custom'] : '' ) );
							?>
						</td>
					</tr>
		...
		public static function get_terms( $filter, $customization, $addkey ) {
			...
			if ( taxonomy_exists( $filter ) && !in_array( $filter, array( 'price', 'per_page' ) ) ) {
				...
				switch ( $filter ) {
					...
					break;
					case 'per_page' :
						$filter_customization = WC_Prdctfltr::get_filter_customization( 'per_page', $addkey );
