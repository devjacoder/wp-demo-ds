       ...
       function resources_settings_table_headers(){
          ...
          ?>
            <th style="width:80px;text-align:center;" rel="tooltip" class="tooltip_bottom"  title="<?php _e('Setting cost for the resource' ,'booking');?>">
             <?php  _e('Cost' ,'booking'); ?>
                    <?php echo ' <span style="font-weight: 600;color:#8F340E;">'; ?>
...
//                }
       ...
       // Show Costs  ?>
                <td style="text-align:center;<?php if ($bt->cost<=0) { echo 'color:#ccc;'; } ?>" <?php echo $alternative_color; ?> >
                    ...
                    <?php echo ' <span style="font-weight: 400;">';  echo $this->get_currency_info(); echo "</span>"; ?>
...
//debuge($booking_type, $booking_days_count, $times_array, $post_form, $is_discount_calculate , $is_only_original_cost);
        ...
        ?>
            ...
            <tr valign="top" class="ver_premium booking_time_advanced_config"  style="<?php if ( get_bk_option( 'booking_type_of_day_selections') == 'single' ) { echo 'display:none;'; } ?>"> 
                ...
                <table id="togle_settings_range_times" style="width:100%;<?php if ($range_selection_time_is_active != 'On') echo "display:none;";/**/ ?>" class="hided_settings_table togle_settings_range_times">
                    <tr>
                    <th scope="row"><label for="range_selection_start_time" ><?php _e('Check-in time' ,'booking'); ?>:</label><br><?php printf(__('%sstart booking time%s' ,'booking'),'<span style="color:#888;font-weight: 600;">','</span>'); ?></th>
                    ...
                    <tr>
                    <th scope="row"><label for="range_selection_end_time" ><?php _e('Check-Out time' ,'booking'); ?>:</label><br><?php printf(__('%send booking time%s' ,'booking'),'<span style="color:#888;font-weight: 600;">','</span>'); ?></th>
