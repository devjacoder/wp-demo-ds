                ...
                ?>
                   <tr>
                        ...
                        <td style="<?php if (isset($bt->parent)) if ($bt->parent != 0 ) { echo 'padding-left:50px;'; } ?>" <?php echo $alternative_color; ?> >
                            ...
                            <span style="<?php if (isset($bt->parent))  if ( ($bt->parent == 0 ) && ( $bt->count > 1 ) )  { echo 'font-weight: 600;'; }?>"><?php echo $bt->title; ?></span>
                            <!--input  maxlength="17" type="text"
                                style="<?php  if (isset($bt->parent))  if ( ($bt->parent == 0 ) && ( $bt->count > 1 ) ) { echo 'width:210px;font-weight: 600;'; } else { echo 'width:170px;font-size:11px;'; } ?>"
