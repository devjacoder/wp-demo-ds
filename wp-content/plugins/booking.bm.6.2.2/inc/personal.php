            ...
            <div class="field">
                <fieldset>
                    ...
                    <select id="bookingselect_resources" name="bookingselect_resources" multiple="MULTIPLE" style="height:90px;">
                        <option value="" style="font-weight: 600;" selected="SELECTED" ><?php echo __('All' ,'booking'); ?></option>
            ...
            <div class="field">
                <fieldset>
                    ...
                    <select id="bookingselect_preselected_resource" name="bookingselect_preselected_resource" >
                        <option value="" style="font-weight: 600;" selected="SELECTED" ><?php echo __('None' ,'booking'); ?></option>
                        <?php foreach ($types_list as $tl) { ?>
                        <option value="<?php echo $tl->id; ?>"
                                    style="<?php if  (isset($tl->parent)) if ($tl->parent == 0 ) { echo 'font-weight: 600;'; } else { echo 'font-size:11px;padding-left:20px;'; } ?>"
                                ><?php echo $tl->title; ?></option>
                      ...
                      foreach ($bk_types as $bt) {
                           ...
                           <tr>
                                ...
                                <td style="<?php if (isset($bt->parent)) if ($bt->parent != 0 ) { echo 'padding-left:50px;'; } ?>" <?php echo $alternative_color; ?> >
                                    <legend class="wpbc_mobile_legend" style="<?php  if ( (isset($bt->parent)) && ($bt->parent == 0 ) ) { echo 'font-weight: 600;'; } ?>" ><?php _e('Resource name' ,'booking'); ?>:</legend>
                                    <input  maxlength="200" type="text"
                                        style="<?php  if (isset($bt->parent)) if ($bt->parent == 0 ) { echo 'width:210px;font-weight: 600;'; } else { echo 'width:170px;'; } ?>"
            ...
            <td>
                ...
                <select id="default_booking_resource" name="default_booking_resource" >
                    ...
                    <option <?php if($default_booking_resource == $mm->booking_type_id ) echo "selected"; ?> value="<?php echo $mm->booking_type_id; ?>"
                          style="<?php if  (isset($mm->parent)) if ($mm->parent == 0 ) { echo 'font-weight: 400;'; } else { echo 'font-size:11px;padding-left:20px;'; } ?>"
...
margin-top:5px;
padding:3px 10px;">
            <div style="float:left;line-height: 32px;font-size:13px;font-weight: 600;text-shadow:0px -1px 0px #fff;color:#555;">-->
                    ...
                    <?php
                        ...
                        foreach ($types_list as $tl) { 
                            ...
                            <option value="<?php echo $tl->id; if  (isset($tl->parent)) if ($tl->parent == 0 )  if  (isset($tl->count))  if ($tl->count > 1 ) echo '&parent_res=1'; ?>"
                                        style="<?php if  (isset($tl->parent)) if ($tl->parent == 0 ) { echo 'font-weight: 600;padding:3px;'; } else { echo 'padding:3px 0 3px 20px;'; } ?>"
