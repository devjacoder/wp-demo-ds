...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	define( 'TAB_TITLE_ICON_TAB', __( "Icon Tab", "js_composer" ) );
	require_once vc_path_dir( 'SHORTCODES_DIR', 'vc-column.php' );

	class WPBakeryShortCode_vc_icon_tabs extends WPBakeryShortCode {
		...
		public function contentAdmin( $atts, $content = null ) {
			...
			preg_match_all( '/vc_icon_tab title="([^\"]+)"(\stab_id\=\"([^\"]+)\"){0,1}/i', $content, $matches, PREG_OFFSET_CAPTURE );
			/*
$tab_titles = array();
...
*/
		...
		public function getTabTemplate() {
			return '<div class="wpb_template">' . do_shortcode( '[vc_icon_tab title="Tab" tab_id=""][/vc_icon_tab]' ) . '</div>';
		}
	...
	class WPBakeryShortCode_vc_icon_tab extends WPBakeryShortCode_VC_Column {

	protected $controls_css_settings = 'tc vc_control-container';
	protected $controls_list = array('add', 'edit', 'clone', 'delete');
	protected $predefined_atts = array(
		'tab_id' => TAB_TITLE_ICON_TAB,
		'title' => ''
	);
