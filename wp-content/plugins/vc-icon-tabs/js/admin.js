...
(function ($) {
   ...
   var i18n = window.i18nLocale,
       ...
       if(typeof model.attributes !='undefined'){
        if( model.attributes.shortcode == 'vc_icon_tabs' ){
     ...
     window.VcIconTabsView = vc.shortcode_view.extend({
        ...
        changedContent:function (view) {
            ...
            var img_url ='';
            if(params.icon_type == 'custom' && typeof params.icon_type !='undefined'){
            ...
            $.ajax({
                ...
                async:false,
                data:{
                    action:'vcit_get_img_url',
                    img_id:params.custom_icon
                },
                context:this
            }).done(function (data) {
                   img_url=data;
            ...
            if (view.model.get('cloned') === true) {
                ...
                if(img_url !=''){
                     $("<li> <i class='icn'><img src='"+img_url+"'></i> <a href='#tab-" + params.tab_id + "'>" + params.title + "</a></li>")
...
window.VcIconTabView = window.VcColumnView.extend({
        ...
        changeShortcodeParams:function (model) {
            ...
            window.VcIconTabView.__super__.changeShortcodeParams.call(this, model);
