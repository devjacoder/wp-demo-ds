...
<ul>
	<li>20+ Predefined Testimonial Theme Styles</li>
	<li>Testimonials from specific Categories</li>
	<li>Front-end Submission form</li>
	<li>Front-end submission form fields show/hide options</li>
	<li>Notification e-mail for Testimonial submission to Admin</li>
	<li>Testimonial pending for approval by Admin to show in front-end</li>
	<li>Grid Testimonial Showcase</li>
	<li>List Testimonial showcase</li>
	<li>Multiple Testimonial Sideshows</li>
	...
	<li>Set Testimonial Auto-play time</li>
	<li>Testimonial stop on hover</li>
	<li>Set different style client images (Circle, Round, Square, Border)</li>
	<li>Show maximum number of testimonials displayed in devices (Mobile, Tablet, Desktop)</li>
	<li>Testimonial Auto height option</li>
	<li>Simple Pagination Style</li>
	<li>Unique settings for each Testimonial</li>
	<li>Unlimited Testimonials in widget area</li>
	<li>Unlimited Testimonials anywhere (like post, page, custom template, sidebar, widget)</li>
	<li>Easy-to-use interface allows you to manage, edit, create, and delete Testimonials with no new knowledge!</li>
	<li>Show/hide Testimonial next/prev buttons</li>
...
The Pro Version is not only awesome Testimonial plugin, but also a complete solution of your Testimonials on the website. <a target="_blank" href="http://shapedplugin.com/plugin/testimonial-pro/">Get Pro Version now only for $29!</a></p>
