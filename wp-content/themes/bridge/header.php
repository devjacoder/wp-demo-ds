...
<header class="<?php echo $header_classes; ?> page_header">
    <div class="container_inner header_inner clearfix">
   <div class="login">
   <img src="http://dusitaspa.democlients.net/wp-content/uploads/2016/10/ic01.png">
   <div class="box_regis">
   <ul>
   <li><a href="http://dusitaspa.democlients.net/register/">Sign-in / Register</a></li>
                ...
                <?php } ?>
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
                            ...
                            <div class="q_logo_hidden"><a href="<?php echo home_url('/'); ?>"><img alt="Logo" src="<?php echo $logo_image_fixed_hidden; ?>"></a></div>
                            <?php } ?>
						</div>
                        </div>
				...
				<?php if($display_header_top == "yes"){ ?>
					<div class="top_header clearfix" <?php echo $header_top_color_per_page; ?> >
						...
						<?php } ?>
								<div class="left">
									<div class="inner">
										<nav class="main_menu drop_down right 01">
										<?php
											wp_nav_menu( array( 
												'theme_location' => 'top-navigation' ,
												'container'  => '',
