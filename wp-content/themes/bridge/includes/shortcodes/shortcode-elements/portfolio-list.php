...
if (!function_exists('portfolio_list')) {
    ...
    function portfolio_list($atts, $content = null) {
        ...
        if (in_array($type,array('masonry','justified_gallery'))) {
        ...
        if(in_array($type,array('hover_text'))){
            switch ($frame_around_item){
                case 'monitor_frame':
                    $frame_around_item_html .= '<img class="monitor_frame" alt="frame" src="' . QODE_ROOT . '/css/img/monitor_frame.png" />';
        ...
        if ($type == 'masonry') {
                            ...
                            if ( $show_icons == 'yes' || $hover_type == 'thin_plus_only' || $hover_type = 'cursor_change_hover') {
                                ...
                                if($hover_type == 'thin_plus_only') {
                                    ...
                                    if ($show_icons == 'yes') {
                                        ...
                                        if($view_button !== "no") {
                                            $html .= '<a class="preview" title="'.esc_html__('Go to Project', 'qode').'" href="' . $portfolio_link . '" data-type="portfolio_list" target="' . $target . '" ></a>';
                                        }
            ...
            $html .= "<div class='projects_holder_outer justified_gallery'>";
            if ($filter == "yes") {
            ...
            if (have_posts()) : while (have_posts()) : the_post();
                ...
                $key_image_html = "";
                $key_image_html .=
                    '<a class="portfolio_jg_image_link image_holder ' . $hover_type . '" href="'.$portfolio_link.'" target="'.$target.'">' .
