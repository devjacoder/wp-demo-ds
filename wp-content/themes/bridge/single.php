									...
									<div class="column_inner">
										<div class="blog_holder blog_single">	
											<?php 
												get_template_part('templates/blog_single', 'loop');
											?>
                                            <div class="box_apsolut">
    
     <span class="position_ar" style="float:left;"><?php previous_post_link('%link', '%title', '<span class="t_pic"><img src="http://samui-island-realty.com/wp-content/uploads/2016/01/arlisting2.png"></span><span class="t_t">Previous</span>', FALSE); ?>  </span>
      <span class="position_ar_right" style=" float:right;"><?php next_post_link('%link', '%title', '<span class="t_pic"><img src="http://samui-island-realty.com/wp-content/uploads/2016/01/arlisting.png"></span><span class="t_t">Next</span>', FALSE); ?>  </span>
